...
const String CLIENT_ID = "888760833138-2viitugqop313ojkg2o375jppbe9bhc0.apps.googleusercontent.com";

// the clientSecret found in Google's Developer Console under API Manager > Credentials
const String CLIENT_SECRET = "qmBVrH-xeynxuN8sYGAVgjxV";

// returned after running FinalizeOAuth
const String REFRESH_TOKEN = "1/gh4ZuchR2_key3HICn-xPpUiDtRe7Kekss28feqChvA";
...
String myName = "James Coggins 30 March"; //Enter your name here
